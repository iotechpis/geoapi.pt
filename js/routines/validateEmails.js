/* validate emails from the geo.iotech.pt, using zerobounce.net */
...
const sections = [
  {
    ...
    content: 'Validate the municipalities and parishes emails of the geo.iotech.pt, using zerobounce.net API or email-verify NPM module'
  },
  {
    header: 'Options',
